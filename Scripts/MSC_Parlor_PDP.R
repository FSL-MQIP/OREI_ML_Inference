...
numVar = c("CowNum", "FullEmpNum", "CertYear", "PplNumPerShift", "NonFamEmpNum", "StockDen", "SPCvar", "GloveFreq")
catVar = c("PartEmp", "Loc", "ParlorFluSys", "ClipFlame", "Parlor", "TowelMacDry", "ClosedHerd")
