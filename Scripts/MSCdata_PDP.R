...
numVar = c("CowNum", "FullEmpNum", "PplNumPerWk", "CertYear","NonFamEmpNum", "SPCvar", "StockDen")
catVar = c("HouseStyle", "ClipFlame", "CowMilkLoc", "Parlor", "CowWaitMilk", "PartEmp", "CowHoldClean", "TowelMacDry", "ParlorHose")
