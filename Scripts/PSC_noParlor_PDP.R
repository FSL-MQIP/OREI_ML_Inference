...
numVar = c("CertYear", "CowNum", "PplNumPerWk", "StockDen", "SPCvar", "PastureTime") #PC1
catVar = c("CowParlorClean", "CornMeal", "BedAddFreq", "CornSilage", "Haylage", "ClipFlame", "BioFeedAdd")
