...
numVar = c("NonFamEmpNum", "PplNumPerWk", "CertYear", "CowNum", "PastureTime", "FullEmpNum", "StockDen") #PC3
catVar = c("NonFamEmp", "ParlorManScrap", "TowelDeter", "PreDipType", "Haylage", "HoldManScrap", "CowMilkLoc")
