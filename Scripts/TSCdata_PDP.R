set.seed(1)
TSC_split= initial_split(TSCdata, prop = 501/502, strata = logConc)
...
TSC_fit = TSC_wf %>% fit(data = TSCdata)
...
ggsave("Figure/Partial dependence plots/TSC/NumVars_TSC.pdf", numPlots_grid, 
...
ggsave("Figure/Partial dependence plots/TSC/CatVars_TSC.pdf", catPlots_grid,
       height = 4, width = 8, units = "in", dpi = "retina")