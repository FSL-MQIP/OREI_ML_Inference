set.seed(1)
BAB_split= initial_split(BABdata, prop = 501/502, strata = logConc)
...
BAB_fit = BAB_wf %>% fit(data = BABdata)
...
ggsave("Figure/Partial dependence plots/BAB/NumVars_BAB.pdf", numPlots_grid, 
...
ggsave("Figure/Partial dependence plots/BAB/CatVars_BAB.pdf", catPlots_grid,
       height = 4, width = 8, units = "in", dpi = "retina")
