...
for (i in 1:length(MSC_list)){
  ...
  vip_features = vip_features %>% 
    sub("_.*", "", .) %>% 
    .[!grepl("PC", .)]
  print(paste0("Top variables are ", vip_features))
  ...
  for (j in 1:length(numVar)) {
    ...
    file_name = paste0("Figure/MSC/PDP/MSC_pdp_", subset_names[i], "_", numVar[j], ".tiff")
  ...
  file_name = paste0("Figure/MSC/NumVars_MSC_", subset_names[i], ".pdf")
  ...
  for (k in 1:length(catVar)) {
    ...
    file_name = paste0("Figure/MSC/PDP/MSC_pdp_", subset_names[i], "_", catVar[k], ".tiff")
    ggsave(file_name, height = 4, width = 4, units = "in", dpi = "retina")
  ...
  file_name = paste0("Figure/MSC/CatVars_MSC_", subset_names[i], ".pdf")
...
for (i in 1:length(TSC_list)){
  ...
  for (j in 1:length(numVar)) {
    ...
    file_name = paste0("Figure/TSC/PDP/TSC_pdp_", subset_names[i], "_", numVar[j], ".tiff")
    ggsave(file_name, height = 4, width = 4, units = "in", dpi = "retina")
  ...
  numPlots_grid = gridExtra::grid.arrange(grobs = numPlots, ncol = 3)
  file_name = paste0("Figure/TSC/NumVars_TSC_", subset_names[i], ".pdf")
  ggsave(file_name, numPlots_grid, 
         height = 4, width = 8, units = "in", dpi = "retina")
  ...
  for (k in 1:length(catVar)) {
    ...
    file_name = paste0("Figure/TSC/PDP/TSC_pdp_", subset_names[i], "_", catVar[k], ".tiff")
    ggsave(file_name, height = 4, width = 4, units = "in", dpi = "retina")
  ...
  catPlots_grid = gridExtra::grid.arrange(grobs = catPlots, ncol = 3)
  file_name = paste0("Figure/TSC/CatVars_TSC_", subset_names[i], ".pdf")
  ggsave(file_name, catPlots_grid,
         height = 4, width = 8, units = "in", dpi = "retina")
...
for (i in 1:length(PSC_list)){
  ...
  for (j in 1:length(numVar)) {
    ...
    file_name = paste0("Figure/PSC/PDP/PSC_pdp_", subset_names[i], "_", numVar[j], ".tiff")
    ggsave(file_name, height = 4, width = 4, units = "in", dpi = "retina")
  ...
  numPlots_grid = gridExtra::grid.arrange(grobs = numPlots, ncol = 3)
  file_name = paste0("Figure/PSC/NumVars_PSC_", subset_names[i], ".pdf")
  ggsave(file_name, numPlots_grid, 
         height = 4, width = 8, units = "in", dpi = "retina")
  ...
  for (k in 1:length(catVar)) {
    ...
    file_name = paste0("Figure/PSC/PDP/PSC_pdp_", subset_names[i], "_", catVar[k], ".tiff")
    ggsave(file_name, height = 4, width = 4, units = "in", dpi = "retina")
  ...
  catPlots_grid = gridExtra::grid.arrange(grobs = catPlots, ncol = 3)
  file_name = paste0("Figure/PSC/CatVars_PSC_", subset_names[i], ".pdf")
  ggsave(file_name, catPlots_grid,
         height = 4, width = 8, units = "in", dpi = "retina")
...
for (i in 1:length(BAB_list)){
  ...
  for (j in 1:length(numVar)) {
    ...
    file_name = paste0("Figure/BAB/PDP/BAB_pdp_", subset_names[i], "_", numVar[j], ".tiff")
    ggsave(file_name, height = 4, width = 4, units = "in", dpi = "retina")
  ...
  numPlots_grid = gridExtra::grid.arrange(grobs = numPlots, ncol = 3)
  file_name = paste0("Figure/BAB/NumVars_BAB_", subset_names[i], ".pdf")
  ggsave(file_name, numPlots_grid, 
         height = 4, width = 8, units = "in", dpi = "retina")
  ...
  for (k in 1:length(catVar)) {
    ...
    file_name = paste0("Figure/BAB/PDP/BAB_pdp_", subset_names[i], "_", catVar[k], ".tiff")
    ggsave(file_name, height = 4, width = 4, units = "in", dpi = "retina")
  ...
  catPlots_grid = gridExtra::grid.arrange(grobs = catPlots, ncol = 3)
  file_name = paste0("Figure/BAB/CatVars_BAB_", subset_names[i], ".pdf")
  ggsave(file_name, catPlots_grid,
         height = 4, width = 8, units = "in", dpi = "retina")
